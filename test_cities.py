...
def test_compute_total_distance():
    ...
    assert cities.compute_total_distance(road_map2) == "Incorrect type. 'road_map' index[2] and [3] must be of float() types."
    
    assert cities.compute_total_distance(road_map3)== "Empty 'road_map', please input correct format: [('state','city','latitude','longitude')]."
    assert cities.compute_total_distance(road_map4) == "Incorrect type. 'road_map' index[2] and [3] must be of float() types."
...
def test_swap_cities():
    ...
    assertcities.swap_cities(road_map4,1,2) == "Incorrect type. 'road_map' index[2] and [3] must be of float() types."
